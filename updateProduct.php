                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select text-center" disabled>
                                                    ...
                                                    (SELECT `brand_id` FROM `brand_has_model` WHERE `id`='" . $product["id"] . "')");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select text-center" disabled>
                                                    ...
                                                    (SELECT `model_id` FROM `brand_has_model` WHERE `id`='" . $product["id"] . "')");
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <textarea cols="30" rows="15" class="form-control" id="d"><?php echo $product["discription"]; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
