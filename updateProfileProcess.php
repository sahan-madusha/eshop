...
if (isset($_SESSION["u"])) {
    ...
    if(isset($_FILES["image"])){
        ...
        //in _array eken wenne file_ex ekata awaeka , allowed_image_extentionskiyana array eke thiyena ewamada kiyala sansandanaya karana eka 
        if(!in_array($file_ex , $allowed_image_extentions)){
            ...
            $file_name = "resource/profile_image/".$_SESSION["u"]["fname"]."_".uniqid().$new_file_extention;
