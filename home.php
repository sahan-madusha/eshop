...
<div class="col-12">
    <div class="row mx-0">
        <div class="col-12 d-none d-lg-block mb-3">
            <div class="row">
            <div id="carouselExampleIndicators" class="col-8 offset-2 carousel slide carousel-fade" data-bs-ride="true">
...
<div class="col-12 mt-3 mb-3">
    <a href="#" class="text-decoration-none link-dark fs-3 fw-bold"><?php echo $cdata["cat_name"]; ?></a> &nbsp;&nbsp;
